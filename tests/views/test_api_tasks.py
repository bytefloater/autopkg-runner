...
class TestTriggerRunView:
    ...
    def test_trigger_run_returns_202_with_task_uuid(self, api_run_manager_client):
        fake_uuid = uuid.uuid4()
        with patch('webapp.runner.trigger_manual_run', return_value=fake_uuid) as mock_trigger:
            resp = api_run_manager_client.post(self.url)
    ...
    def test_trigger_run_while_running_returns_409(self, api_run_manager_client):
...
class TestTriggerDbCleanupView:
    ...
    def test_trigger_cleanup_returns_202_with_task_uuid(self, api_run_manager_client):
        fake_uuid = uuid.uuid4()
...
class TestGetTaskStatusView:
    ...
    def test_existing_task_returns_status_fields(self, api_run_manager_client):
        ...
        resp = api_run_manager_client.get(self.url, {'uuid': str(fake_uuid)})
