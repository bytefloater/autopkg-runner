...
urlpatterns = [
    ...
    path('runs/munki-icon/',
         runs.munki_icon_proxy, name='munki-icon-proxy'),
    path('runs/<uuid:run_id>/cancel/',
    ...
    # -- Configuration root ----------------------------------------------------
    path('config/',
         config.ConfigRootView.as_view(), name='config'),
    ...
    path('favicon.ico',
         RedirectView.as_view(url='/static/logos/favicon.ico', permanent=True), name='favicon'),
    path('manifest.json',
         pwa.ManifestView.as_view(), name='manifest'),
    path('sw.js',
         pwa.ServiceWorkerView.as_view(), name='service-worker'),
    path('login/',
         account.MobileAwareLoginView.as_view(), name='login'),
    path('logout/',
